...
The length (qubits) of the register is $n^2$ and the number in the cell is represented using one-hot encoding.
...
\begin{figure}[H]
  \centering
    \includegraphics[width=0.3\linewidth]{content/assets/03_grovers_algorithm/weighted_adder.png}
    \caption{WeightedAdder circuit}
\end{figure}
